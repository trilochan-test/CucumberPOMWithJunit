...
public class AccountsPageSteps {
	...
	public void user_gets_accounts_section(DataTable sectionsTable) {
		...
		Assert.assertTrue(expAccountSectionsList.containsAll(actualAccountsSectionsList));
	}

	@Then("Accounts section count should be {int}")
	public void accounts_section_count_should_be(Integer actualSectionCount) {
		Assert.assertTrue(accountsPage.getAccountsSectionCount() == actualSectionCount);
	}
